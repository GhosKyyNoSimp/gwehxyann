...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('Ghos Bid', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Powered By Iyan & Arasya & Xyanndex ]')}\n\n${chalk.red('Ghoskyy Md')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@iamghosky_')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 896-5338-1067')}\n${chalk.red('Donate')} : ${chalk.white('089653381067 ( Ovo/Dana/Pulsa )')}\n`))
}
...
const connectToWhatsApp = async () => {
	const conn = makeWASocket({
            ...
            auth: state,
            browser: ["Ghos Bid MD", "Safari", "3.0"]
        })
	title()
        store.bind(conn.ev)
